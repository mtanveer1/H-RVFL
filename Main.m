...
%% Data Preparation
addpath(genpath('C:\Users\mushi\OneDrive\Desktop\HE-RVFL-GitHub-code'))
...
[Train_Accuracy, Test_Accuracy]   = HE_RVFL_Function(trainX,trainY,testX,testY,option);

fprintf(1, 'Training Accuracy of HE_RVFL model is: %f\n', Train_Accuracy);
fprintf(1, 'Testing Accuracy of HE_RVFL model is: %f\n', Test_Accuracy);
